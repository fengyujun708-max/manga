...
1. **先手动构建APK**
   ...
   APK位置：`漫界 MangaVerse/app/build/outputs/apk/release/app-release.apk`
...
2. **在GitHub上创建Release**
   ...
   - 填写以下信息：
     ...
     - Release title: 输入标题（如 `漫界 MangaVerse v1.0.0`）
     - Description: 输入更新说明
   - 拖拽或选择APK文件上传
   - 点击 "Publish release"
...
在发布前，记得更新 `漫界 MangaVerse/app/build.gradle` 中的版本信息：
