package com.mangaverse.app.core.parser.dynamic
...
import com.mangaverse.app.core.model.jsonsource.*
import com.mangaverse.app.core.parser.rule.DefaultRuleEngine
import com.mangaverse.app.core.parser.rule.RuleCache
...
class DynamicParserIntegrationTest {
	...
	private fun createMockContext(): ContentLoaderContext {
		...
		return object : ContentLoaderContext {
			...
			override fun getConfig(source: com.mangaverse.app.parsers.model.ContentParserSource): com.mangaverse.app.parsers.config.ContentSourceConfig {
				return object : com.mangaverse.app.parsers.config.ContentSourceConfig {
					override fun <T> get(key: com.mangaverse.app.parsers.config.ConfigKey<T>): T {
						@Suppress("UNCHECKED_CAST")
						return when (key) {
							is com.mangaverse.app.parsers.config.ConfigKey.Domain -> "example.com" as T
							else -> throw IllegalArgumentException("Unknown config key")
						}
					}
					
					override fun <T> set(key: com.mangaverse.app.parsers.config.ConfigKey<T>, value: T) {}
				}
			}
	...
	private fun createMockParser(): com.mangaverse.app.parsers.ContentParser {
		val config = createTestLegadoConfig()
		val context = createMockContext()
