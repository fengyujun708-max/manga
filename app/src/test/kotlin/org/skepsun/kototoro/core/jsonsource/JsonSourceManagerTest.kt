...
class JsonSourceManagerTest {
	...
	fun testValidateLegadoSourceValid() {
		val validSource = com.mangaverse.app.core.model.jsonsource.LegadoBookSource(
	...
	fun testValidateLegadoSourceBlankName() {
		val invalidSource = com.mangaverse.app.core.model.jsonsource.LegadoBookSource(
			bookSourceName = "",
			bookSourceUrl = "https://example.com",
		)
	...
	fun testValidateLegadoSourceBlankUrl() {
		val source = com.mangaverse.app.core.model.jsonsource.LegadoBookSource(
			bookSourceName = "Test Source",
			bookSourceUrl = "",
		)
