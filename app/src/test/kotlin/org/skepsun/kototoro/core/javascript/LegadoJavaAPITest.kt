...
class LegadoJavaAPITest : FunSpec({
    ...
    beforeTest {
        ...
        every { context.packageName } returns "com.mangaverse.app.test"
    ...
    test("get 在启用 cookieJar 时应自动注入持久化 Cookie 头") {
        val cookieJar = mockk<com.mangaverse.app.core.network.jsonsource.PersistentCookieJar>()
    ...
    test("startBrowserAwait 应保留浏览器最终跳转 URL，贴近 MD3 语义") {
        ...
        val sourceSlot = slot<com.mangaverse.app.parsers.model.ContentSource>()
        every {
