...
import com.mangaverse.app.core.model.jsonsource.BookInfoRule
...
import com.mangaverse.app.core.model.jsonsource.SearchRule
...
class BookInfoAndContentAlignmentTest : FunSpec({
    ...
    test("BookInfo 声明 downloadUrls 规则时应按 web file 分支处理") {
        val source = mockk<ContentSource> {
            ...
            every { contentType } returns com.mangaverse.app.parsers.model.ContentType.OTHER
        }
