...
class BackupPayloadGuardTest {
	...
	fun `current Kototoro restore accepts only current semantic schema`() {
		val current = indexedBackup("com.mangaverse.app", semanticSchemaVersion = 3)
		val nightly = indexedBackup("com.mangaverse.app.nightly", semanticSchemaVersion = 3)
		val debug = indexedBackup("com.mangaverse.app.debug", semanticSchemaVersion = 3)
