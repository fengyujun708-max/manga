package com.mangaverse.app.work.data
...
import com.mangaverse.app.work.domain.WorkProjectionBindingAction
...
class DefaultWorkResolverTest {
	...
	fun `bindProjectionToEntity rejects an unbound projection from another media family`() = runTest {
		...
		assertEquals(
			com.mangaverse.app.work.domain.WorkProjectionBindingConflict.TARGET_CONTENT_TYPE_CONFLICT,
