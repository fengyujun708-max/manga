...
Java_com_mangaverse_app_reader_translate_data_RealCuganNcnnEngine_initNative(JNIEnv *env, jobject thiz, jstring paramPath, jstring binPath, jint gpuId, jboolean ttaMode) {
...
Java_com_mangaverse_app_reader_translate_data_RealCuganNcnnEngine_processNative(JNIEnv *env, jobject thiz, jlong nativeHandle, jobject inBitmap, jobject outBitmap) {
...
Java_com_mangaverse_app_reader_translate_data_RealCuganNcnnEngine_releaseNative(JNIEnv *env, jobject thiz, jlong nativeHandle) {
    auto* cugan = reinterpret_cast<RealCUGAN*>(nativeHandle);
    if (cugan) {
        delete cugan;
