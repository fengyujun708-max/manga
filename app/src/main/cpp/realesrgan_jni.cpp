...
Java_com_mangaverse_app_reader_translate_data_RealEsrganNcnnEngine_initNative(JNIEnv *env, jobject thiz, jstring paramPath, jstring binPath, jint gpuId, jboolean ttaMode) {
...
Java_com_mangaverse_app_reader_translate_data_RealEsrganNcnnEngine_processNative(JNIEnv *env, jobject thiz, jlong nativeHandle, jobject inBitmap, jobject outBitmap) {
...
Java_com_mangaverse_app_reader_translate_data_RealEsrganNcnnEngine_releaseNative(JNIEnv *env, jobject thiz, jlong nativeHandle) {
    auto* esrgan = reinterpret_cast<RealESRGAN*>(nativeHandle);
    if (esrgan) {
        delete esrgan;
