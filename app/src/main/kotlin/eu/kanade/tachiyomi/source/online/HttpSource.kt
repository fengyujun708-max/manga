...
abstract class HttpSource : CatalogueSource {
    ...
    private fun tagRequest(request: Request): Request {
		if (request.tag(com.mangaverse.app.mihon.compat.SourceRequestContext::class.java) != null) {
            return request
        }
        ...
        return request.newBuilder()
			...
			.tag(
				com.mangaverse.app.mihon.compat.SourceRequestContext::class.java,
				com.mangaverse.app.mihon.compat.SourceRequestContext.from(source, baseUrl),
			)
            .build()
    }
    ...
    private fun mihonContentSource(): ContentSource {
        return com.mangaverse.app.core.model.ContentSource("MIHON_$id")
    }
