...
import com.mangaverse.app.core.model.getSummary
...
fun SourcesCatalogRoute(
    ...
    onBack: () -> Unit,
    onOpenSource: (com.mangaverse.app.parsers.model.ContentSource) -> Unit,
) {
...
fun SourcesCatalogScreen(
    items: List<com.mangaverse.app.list.ui.model.ListModel>,
    ...
    onSourceClick: (com.mangaverse.app.parsers.model.ContentSource) -> Unit,
    onAddSource: (com.mangaverse.app.parsers.model.ContentSource) -> Unit,
) {
