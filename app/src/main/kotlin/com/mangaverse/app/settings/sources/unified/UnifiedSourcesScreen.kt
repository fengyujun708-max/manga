...
import com.mangaverse.app.extensions.runtime.getExternalExtensionLanguageDisplayName
import com.mangaverse.app.extensions.repo.ExternalExtensionRepo
import com.mangaverse.app.parsers.model.ContentType
import com.mangaverse.app.settings.sources.extensions.formatExtensionFingerprint
...
private fun UnifiedSourcePackageItem.installedIconPackageName(): String? {
	if (!isInstalled) {
		...
		return when (kind) {
			UnifiedSourceKind.MIHON,
			UnifiedSourceKind.JAR -> packageName
			else -> null
	}
}
