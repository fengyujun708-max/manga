...
import com.mangaverse.app.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "com.mangaverse.app.download.PAUSE"
		private const val ACTION_RESUME = "com.mangaverse.app.download.RESUME"
		private const val ACTION_SKIP = "com.mangaverse.app.download.SKIP"
		private const val ACTION_SKIP_ALL = "com.mangaverse.app.download.SKIP_ALL"
