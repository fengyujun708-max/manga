...
enum class NavItem(
	...
	FAVORITES(R.id.nav_favorites, R.string.library, R.drawable.ic_favourites_selector),
	LOCAL(R.id.nav_local, R.string.on_device, R.drawable.ic_storage_selector),
	EXPLORE(R.id.nav_explore, R.string.universe, R.drawable.ic_explore_selector),
	...
	ENERGY(R.id.nav_energy, R.string.energy, R.drawable.ic_energy_selector),
	PROFILE(R.id.nav_profile, R.string.profile, R.drawable.ic_profile_selector),
	;
