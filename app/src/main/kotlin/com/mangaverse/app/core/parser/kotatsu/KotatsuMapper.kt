...
import com.mangaverse.app.parsers.model.Favicon
...
internal fun org.koitharu.kotatsu.parsers.model.MangaTag.toKototoro(source: ContentSource): com.mangaverse.app.parsers.model.ContentTag =
	com.mangaverse.app.parsers.model.ContentTag(title, key, source)
