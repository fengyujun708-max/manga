...
import com.mangaverse.app.core.parser.tsuki.TsukiContentParserAdapter
import com.mangaverse.app.core.parser.tsuki.TsukiContentSource
import com.mangaverse.app.core.parser.tsuki.TsukiLoaderContextAdapter
...
class PluginClassLoader(
    ...
    override fun loadClass(name: String, resolve: Boolean): Class<*> {
        ...
        if (name == "com.mangaverse.app.parsers.ContentParserFactoryKt" ||
            name == "org.koitharu.kotatsu.parsers.MangaParserFactoryKt" ||
            name == "tsuki.MangaParserFactoryKt" ||
            name == "com.mangaverse.app.parsers.model.ContentParserSource" ||
        ...
        if (name.startsWith("org.koitharu.kotatsu.parsers.model.") ||
            ...
            name.startsWith("com.mangaverse.app.parsers.model.") ||
            name.startsWith("com.mangaverse.app.parsers.config.") ||
            name == "com.mangaverse.app.parsers.ContentLoaderContext" ||
            name == "com.mangaverse.app.parsers.ContentParser" ||
            name.startsWith("com.mangaverse.app.parsers.util.LinkResolver")
        ) {
        ...
        if (name.startsWith("org.koitharu.kotatsu.parsers.site.") ||
            ...
            name.startsWith("com.mangaverse.app.parsers.site.") ||
            name.startsWith("com.mangaverse.app.parsers.core.") ||
            name.startsWith("com.mangaverse.app.parsers.util.") ||
            name.startsWith("com.mangaverse.app.parsers.network.") ||
            name.startsWith("com.mangaverse.app.parsers.exception.") ||
            name.startsWith("com.mangaverse.app.parsers.ContentParserFactory")
        ) {
            try {
...
object JarExtensionLoader {
    ...
    fun loadFromDirectory(context: Context, pluginDir: File): List<LoadedJarPlugin> {
        ...
        for (jarFile in jarFiles) {
            ...
            try {
                ...
                while (entries.hasMoreElements()) {
                    ...
                    try {
                        ...
                        val brokenKototoro = clazz.getAnnotation(com.mangaverse.app.parsers.Broken::class.java)
                        if (brokenKototoro != null) {
                            val contentParserAnn = clazz.getAnnotation(com.mangaverse.app.parsers.ContentSourceParser::class.java)
            ...
            try {
                val factoryClass = dexClassLoader.loadClass("com.mangaverse.app.parsers.ContentParserFactoryKt")
                val newParserMethod = findParserFactoryMethod(factoryClass, ContentLoaderContext::class.java)
                val fallbackSourceClass = tryFindEnumClass(dexClassLoader, "com.mangaverse.app.parsers.model.ContentParserSource")
