...
import com.mangaverse.app.core.util.ext.readStringSet
import com.mangaverse.app.core.util.ext.writeStringSet
...
data class ParcelableContent(
	...
	companion object : Parceler<ParcelableContent> {
		...
		override fun create(parcel: Parcel): ParcelableContent {
			...
			val contentRating = parcel.readSerializableCompat<com.mangaverse.app.parsers.model.ContentRating>()
			...
			val state = parcel.readSerializableCompat<com.mangaverse.app.parsers.model.ContentState>()
			...
			val chapters = if (chaptersSize >= 0) {
				List(chaptersSize) {
					com.mangaverse.app.parsers.model.ContentChapter(
						id = parcel.readLong(),
