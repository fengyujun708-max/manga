...
import com.mangaverse.app.core.parser.legado.LegadoCloudFlareResolver
import com.mangaverse.app.core.parser.legado.RequestPriority
...
import com.mangaverse.app.core.util.EncodingDetect
    ...
    override suspend fun execute(plan: LegadoRequestPlan): LegadoHttpResponse {
        ...
        repeat(maxRetries) { attempt ->
            try {
                ...
                return rateLimiter.withLimit(priority) {
                    ...
                    when (CloudFlareHelper.checkResponseForProtection(response)) {
                        CloudFlareHelper.PROTECTION_CAPTCHA -> {
                            ...
                            throw com.mangaverse.app.core.exceptions.CloudFlareProtectedException(
                        ...
                        CloudFlareHelper.PROTECTION_BLOCKED -> {
                            ...
                            throw com.mangaverse.app.core.exceptions.CloudFlareBlockedException(
                                url = finalUrl,
                                source = source,
                            )
                        }
                ...
                if (e is com.mangaverse.app.core.exceptions.CloudFlareException) throw e

                if (e is com.mangaverse.app.parsers.exception.TooManyRequestExceptions) {
