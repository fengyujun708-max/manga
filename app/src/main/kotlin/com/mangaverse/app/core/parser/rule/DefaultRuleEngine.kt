package com.mangaverse.app.core.parser.rule
...
class DefaultRuleEngine @Inject constructor(
	...
	override fun parseField(element: Element, rule: String): String {
		...
		return try {
			...
			com.mangaverse.app.core.jsonsource.JsonSourceLogger.logRuleSyntaxError(rule, e.message ?: "Unknown error")
			""
		}
	}
	...
	override fun parseList(
		...
		return try {
			...
			if (items.isEmpty()) {
				com.mangaverse.app.core.jsonsource.JsonSourceLogger.logWarning(
			...
			com.mangaverse.app.core.jsonsource.JsonSourceLogger.logError("Error parsing list with rule '$listRule'", e)
			emptyList()
		}
	}
	...
	private fun compileRegexRule(rule: String): CompiledRule {
		...
		val validation = com.mangaverse.app.core.jsonsource.SecurityValidator.validateRegex(pattern)
	...
	private fun executeCssRule(element: Element, rule: CompiledRule): String {
		return try {
			...
			com.mangaverse.app.core.jsonsource.JsonSourceLogger.logRuleSyntaxError(
				"CSS: ${rule.selector}",
