...
interface ContentRepository {
	...
	fun createCoverRequest(imageUrl: String): okhttp3.Request {
		return com.mangaverse.app.reader.domain.PageLoader.createPageRequest(imageUrl, source)
	}
	...
	fun isSlowdownEnabled(): Boolean {
		return source != LocalMangaSource && source != TestContentSource
	}

	suspend fun getRelated(seed: Content): List<Content>

	suspend fun getConfigKeys(): List<com.mangaverse.app.parsers.config.ConfigKey<*>> = emptyList()
