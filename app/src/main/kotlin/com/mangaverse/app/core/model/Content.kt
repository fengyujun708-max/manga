...
import com.mangaverse.app.core.util.ext.iterator
...
fun Content.isNsfw(): Boolean {
	if (contentRating == com.mangaverse.app.parsers.model.ContentRating.SAFE) return false
	...
	if (contentRating == com.mangaverse.app.parsers.model.ContentRating.ADULT) return true
