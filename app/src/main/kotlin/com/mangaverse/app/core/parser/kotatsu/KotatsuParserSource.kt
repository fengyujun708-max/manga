...
data class KotatsuParserSource(
    ...
    val title: String = try {
        val underlying = if (delegate is com.mangaverse.app.core.extensions.PluginMangaSource) delegate.originalSource else delegate
    ...
    val isBroken: Boolean
        get() = com.mangaverse.app.core.extensions.GlobalExtensionManager.mangaSources.value
