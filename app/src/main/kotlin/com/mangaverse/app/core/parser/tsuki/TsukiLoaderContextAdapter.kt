...
import com.mangaverse.app.core.extensions.JarExtensionLoader
import com.mangaverse.app.core.extensions.LoadedJarPlugin
...
internal class TsukiLoaderContextAdapter(
    ...
    override fun requestBrowserAction(parser: tsuki.MangaParser, url: String): Nothing {
        throw com.mangaverse.app.core.exceptions.InteractiveActionRequiredException(
...
private class TsukiBitmapAdapter(
    val delegate: com.mangaverse.app.parsers.bitmap.Bitmap,
) : tsuki.bitmap.Bitmap {
...
private fun tsuki.bitmap.Rect.toKototoro() = com.mangaverse.app.parsers.bitmap.Rect(left, top, right, bottom)
