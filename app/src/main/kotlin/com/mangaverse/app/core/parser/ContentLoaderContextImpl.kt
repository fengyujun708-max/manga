...
import com.mangaverse.app.parsers.bitmap.Bitmap
...
import com.mangaverse.app.parsers.util.map
...
class ContentLoaderContextImpl @Inject constructor(
	...
	val webViewRequestInterceptorExecutor: com.mangaverse.app.core.network.webview.WebViewRequestInterceptorExecutor,
) : ContentLoaderContext() {

	private val jsTimeout = TimeUnit.SECONDS.toMillis(4)

	override fun newParserInstance(source: ContentSource): com.mangaverse.app.parsers.ContentParser {
		val extensionManager = com.mangaverse.app.core.extensions.GlobalExtensionManager
		return extensionManager.getContentParser(source, this)
	}

	override fun newLinkResolver(link: okhttp3.HttpUrl): com.mangaverse.app.parsers.util.LinkResolver {
