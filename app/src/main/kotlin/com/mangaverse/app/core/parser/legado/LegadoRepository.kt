...
import com.mangaverse.app.core.parser.RelatedContentSearchFallback
import com.mangaverse.app.core.parser.legado.bridge.KototoroLegadoHttpExecutor
import com.mangaverse.app.core.parser.legado.bridge.KototoroLegadoRuntimeBridge
...
import com.mangaverse.app.core.parser.legado.runtime.LegadoRuleRuntimeContext
import com.mangaverse.app.core.parser.legado.runtime.LegadoRequestPlan
import com.mangaverse.app.core.parser.legado.runtime.StandaloneLegadoListRuntime
import com.mangaverse.app.core.parser.legado.runtime.StandaloneLegadoRuntimeState
...
import com.mangaverse.app.core.parser.legado.bridge.KototoroLegadoCookieStore
import com.mangaverse.app.core.parser.legado.bridge.KototoroLegadoVariableStore
import com.mangaverse.app.core.parser.legado.bridge.LegadoSandboxRuleRuntimeContext
import com.mangaverse.app.core.parser.legado.bridge.StandaloneLegadoRuleRuntimeContext
import com.mangaverse.app.parsers.model.*
import okhttp3.HttpUrl.Companion.toHttpUrlOrNull
import java.nio.charset.Charset
import com.mangaverse.app.core.cache.MemoryContentCache
import com.mangaverse.app.core.cache.SafeDeferred
...
class LegadoRepository(
    ...
    private val browserLauncher: com.mangaverse.app.core.javascript.BrowserLauncher? = null,
    private val legadoPrefs: android.content.SharedPreferences? = null
) : ContentRepository, com.mangaverse.app.parsers.ContentParserAuthProvider {
    ...
    private val runtimeBridge by lazy {
        ...
        val cookieStore = KototoroLegadoCookieStore(
            com.mangaverse.app.core.javascript.LegadoCookieAPI(
                com.mangaverse.app.core.network.jsonsource.PersistentCookieJar(httpClient.getCookieJar()),
            ),
        )
        KototoroLegadoRuntimeBridge(
            ...
            logger = com.mangaverse.app.core.parser.legado.runtime.NoOpLegadoRuntimeLogger,
        )
    }
    ...
    private fun shouldUseStandaloneListRuntimeForDebug(): Boolean {
        if (!com.mangaverse.app.BuildConfig.DEBUG) return false
    ...
    private suspend fun executeRequest(plan: LegadoRequestPlan): Pair<String, String>? {
        return try {
            ...
            if (e is com.mangaverse.app.core.exceptions.CloudFlareProtectedException) throw e
    ...
    private suspend fun executeRequestWithLoginCheck(
        ...
        return when (jsResult) {
            ...
            is com.mangaverse.app.core.javascript.StrResponse -> jsResult.body() to jsResult.url()
    ...
    override fun getPagesFlow(chapter: ContentChapter, nextChapterUrl: String?): Flow<List<ContentPage>> = kotlinx.coroutines.flow.channelFlow {
        ...
        while (queue.isNotEmpty()) {
            ...
            } catch (e: com.mangaverse.app.parsers.exception.ContentUnavailableException) {
    ...
    private suspend fun ProducerScope<List<ContentPage>>.sendStandalonePagesFlow(
        ...
        runtimeContext.setChapter(
            com.mangaverse.app.core.javascript.ChapterInfo(
    ...
    private suspend fun getChaptersHelperWithStandaloneRuntime(
        ...
        runtimeContext.setBook(
            com.mangaverse.app.core.javascript.BookInfo(
                bookUrl = manga.url,
                name = manga.title,
    ...
    private fun applyTocFormatJsForSandbox(
        ...
        return chapters.mapIndexed { index, chapter ->
            val chapterContext = com.mangaverse.app.core.javascript.ChapterInfo(
                chapterUrl = chapter.url,
                name = chapter.title.orEmpty(),
                index = index + 1,
            )
