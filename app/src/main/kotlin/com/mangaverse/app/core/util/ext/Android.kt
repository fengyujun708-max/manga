...
fun WebView.configureForParser(userAgentOverride: String?, blockImages: Boolean = false) = with(settings) {
	...
	val finalUa = userAgentOverride?.let { com.mangaverse.app.core.network.UserAgentProvider.sanitize(it) }
		?: com.mangaverse.app.core.network.UserAgentProvider.get(this@configureForParser.context)
