...
import com.mangaverse.app.core.javascript.BookInfo
import com.mangaverse.app.core.javascript.ChapterInfo
import com.mangaverse.app.core.parser.legado.bridge.LegadoSandboxJsEvaluator
...
import com.mangaverse.app.core.parser.legado.runtime.LegadoHttpResponse
...
class AnalyzeUrl(
    ...
    ): com.mangaverse.app.core.javascript.StrResponse {
    ...
    fun getErrStrResponse(e: Throwable): com.mangaverse.app.core.javascript.StrResponse {
        return com.mangaverse.app.core.javascript.StrResponse(getErrResponse(e), e.stackTraceToString())
    }
    ...
    private fun toStrResponse(response: LegadoHttpResponse): com.mangaverse.app.core.javascript.StrResponse {
        return com.mangaverse.app.core.javascript.StrResponse(
            url = response.url,
