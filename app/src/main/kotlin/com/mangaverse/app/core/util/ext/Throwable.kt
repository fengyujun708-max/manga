...
import com.mangaverse.app.core.exceptions.BadBackupFormatException
import com.mangaverse.app.core.exceptions.CaughtException
...
import com.mangaverse.app.core.exceptions.IncompatiblePluginException
import com.mangaverse.app.core.exceptions.InteractiveActionRequiredException
import com.mangaverse.app.core.exceptions.MissingPluginHostClassesException
import com.mangaverse.app.core.exceptions.NoDataReceivedException
import com.mangaverse.app.core.exceptions.NonFileUriException
import com.mangaverse.app.core.exceptions.ProxyConfigException
import com.mangaverse.app.core.exceptions.SyncApiException
...
import com.mangaverse.app.core.exceptions.WrongPasswordException
import com.mangaverse.app.core.image.ImageDecodeException
import com.mangaverse.app.core.exceptions.resolve.ExceptionResolver
import com.mangaverse.app.core.model.getContentType
import com.mangaverse.app.core.model.getUnsupportedSourceTitleResId
import com.mangaverse.app.parsers.ErrorMessages.FILTER_BOTH_LOCALE_GENRES_NOT_SUPPORTED
import com.mangaverse.app.parsers.ErrorMessages.FILTER_BOTH_STATES_GENRES_NOT_SUPPORTED
import com.mangaverse.app.parsers.ErrorMessages.FILTER_MULTIPLE_GENRES_NOT_SUPPORTED
import com.mangaverse.app.parsers.ErrorMessages.FILTER_MULTIPLE_STATES_NOT_SUPPORTED
import com.mangaverse.app.parsers.ErrorMessages.SEARCH_NOT_SUPPORTED
import com.mangaverse.app.parsers.model.ContentType
import com.mangaverse.app.parsers.exception.AuthRequiredException
import com.mangaverse.app.parsers.exception.ContentUnavailableException
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/com.mangaverse.app/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/com.mangaverse.app/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
