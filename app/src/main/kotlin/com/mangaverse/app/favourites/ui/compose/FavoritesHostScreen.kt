package com.mangaverse.app.favourites.ui.compose
...
import com.mangaverse.app.favourites.ui.container.FavouriteTabModel
import com.mangaverse.app.favourites.ui.container.FavouritesContainerViewModel
...
fun DuplicatesFinderDialog(
    state: com.mangaverse.app.favourites.ui.container.DuplicatesFinderState,
    onDismiss: () -> Unit,
    onCancel: () -> Unit,
    onQuickFix: () -> Unit,
    onFuzzyFix: (Int) -> Unit,
...
fun DuplicatesSummaryDialog(
    summary: com.mangaverse.app.favourites.ui.container.DuplicatesSummaryState,
    onDismiss: () -> Unit
) {
    AlertDialog(
