...
import com.mangaverse.app.core.db.TABLE_ENTITY_GRAPH_BINDING
import com.mangaverse.app.core.db.TABLE_ENTITY_PREFERENCES
import com.mangaverse.app.core.db.TABLE_FAVOURITE_CATEGORIES
import com.mangaverse.app.core.db.TABLE_MANGA
import com.mangaverse.app.core.db.TABLE_MANGA_TAGS
import com.mangaverse.app.core.db.TABLE_PREFERENCES
import com.mangaverse.app.core.db.TABLE_TAGS
import com.mangaverse.app.core.db.TABLE_WORK_FAVOURITES
import com.mangaverse.app.core.db.TABLE_WORK_HISTORY
...
import com.mangaverse.app.favourites.data.FavouriteCategoryCountEntry
import com.mangaverse.app.favourites.data.FavouriteEntity
import com.mangaverse.app.favourites.data.WorkFavouriteEntity
import com.mangaverse.app.favourites.data.stabilizeActiveWorkFavouriteAnchor
import com.mangaverse.app.favourites.data.toFavouriteCategory
...
import com.mangaverse.app.work.domain.matchesPublicationStateFilters
...
class FavouritesRepository @Inject constructor(
	...
	fun observeCategoryCountEntries(): Flow<List<com.mangaverse.app.favourites.data.FavouriteCategoryCountEntry>> {
		return db.invalidationTracker.createFlow(
			TABLE_WORK_FAVOURITES,
