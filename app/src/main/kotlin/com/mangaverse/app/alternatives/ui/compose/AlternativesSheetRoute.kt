package com.mangaverse.app.alternatives.ui.compose
...
import com.mangaverse.app.alternatives.ui.AlternativesViewModel
...
fun AlternativesSheetRoute(
    ...
    onOpenSourceSearch: (source: com.mangaverse.app.parsers.model.ContentSource, query: String) -> Unit,
