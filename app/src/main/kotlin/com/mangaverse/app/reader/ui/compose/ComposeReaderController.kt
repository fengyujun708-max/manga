...
import com.mangaverse.app.reader.ui.ReaderErrorHost
import com.mangaverse.app.reader.ui.ReaderNavigator
import com.mangaverse.app.reader.ui.ReaderState
import com.mangaverse.app.reader.ui.ReaderViewModel
import com.mangaverse.app.reader.ui.ReaderActionsUiState
import com.mangaverse.app.reader.ui.resolveReaderCurrentPagePosition
import com.mangaverse.app.reader.ui.resolveReaderInitialPagePosition
		...
		ComposeReaderActivityScaffold(
					...
					callbacks = chromeCallbacks.copy(
						...
						onPrimaryDestination = { destination ->
							when {
								destination == com.mangaverse.app.reader.ui.compose.design.ReaderControlDestination.DISPLAY &&
									chromeState.options.visible -> hideOptions()
								destination == com.mangaverse.app.reader.ui.compose.design.ReaderControlDestination.TOOLS &&
