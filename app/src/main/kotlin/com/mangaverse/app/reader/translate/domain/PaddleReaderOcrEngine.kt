...
class PaddleReaderOcrEngine @Inject constructor(
	...
	private data class ModelPair(
		val detector: com.mangaverse.app.reader.translate.data.OnnxOfficialModel,
		val recognizer: com.mangaverse.app.reader.translate.data.OnnxOfficialModel,
	)
	...
	private fun resolveDetectorModel(): com.mangaverse.app.reader.translate.data.OnnxOfficialModel? {
	...
	private fun resolveRecognizerModel(
		automaticLanguage: String?,
	): com.mangaverse.app.reader.translate.data.OnnxOfficialModel? {
	...
	private fun resolvePreferredDownloadedRecognizer(
		models: List<com.mangaverse.app.reader.translate.data.OnnxOfficialModel>,
	 ...
	 */
	private fun findOnnxFile(dir: File, model: com.mangaverse.app.reader.translate.data.OnnxOfficialModel): File? {
	...
	private fun resolveDetectorNormalizeMode(
		model: com.mangaverse.app.reader.translate.data.OnnxOfficialModel,
