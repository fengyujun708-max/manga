...
import com.mangaverse.app.core.prefs.ReaderControl
...
import com.mangaverse.app.core.ui.util.SystemUiController
import com.mangaverse.app.core.ui.util.MenuInvalidator
import com.mangaverse.app.core.util.IdlingDetector
import com.mangaverse.app.core.util.ShareHelper
import com.mangaverse.app.core.util.ext.isAnimationsEnabled
...
import com.mangaverse.app.core.util.ext.postDelayed
import com.mangaverse.app.core.util.ext.performConfirmHapticFeedback
import com.mangaverse.app.core.util.ext.performSegmentHapticFeedback
import com.mangaverse.app.core.util.ext.toUriOrNull
import com.mangaverse.app.core.util.ext.zipWithPrevious
import com.mangaverse.app.details.ui.compose.ChaptersPagesTabsContent
import com.mangaverse.app.details.ui.compose.DETAILS_TAB_BOOKMARKS
import com.mangaverse.app.details.ui.compose.DETAILS_TAB_PAGES
...
import com.mangaverse.app.reader.domain.TapGridArea
import com.mangaverse.app.reader.ui.config.ImageServerDelegate
import com.mangaverse.app.reader.ui.compose.ComposeReaderController
import com.mangaverse.app.reader.ui.compose.ComposeReaderChromeCallbacks
import com.mangaverse.app.reader.ui.compose.ComposeReaderOptionsCallbacks
import com.mangaverse.app.reader.ui.compose.ReaderChapterPanelCallbacks
import com.mangaverse.app.reader.ui.compose.ComposeReaderOptionsState
import com.mangaverse.app.reader.ui.compose.ReaderAutoScrollCallbacks
import com.mangaverse.app.reader.ui.compose.DefaultComposeReaderImagePipeline
import com.mangaverse.app.reader.domain.TranslationLayerState
import com.mangaverse.app.reader.translate.domain.isAutoReaderTranslationLanguage
import com.mangaverse.app.reader.ui.eink.EInkPageIdentity
import com.mangaverse.app.reader.ui.eink.EInkRefreshPolicy
        ...
        composeReaderController = ComposeReaderController(
            ...
            chromeCallbacks = ComposeReaderChromeCallbacks(
				...
				onPrimaryDestination = { destination ->
					when (destination) {
						com.mangaverse.app.reader.ui.compose.design.ReaderControlDestination.NAVIGATION -> {
							if (!onPagesButtonClick()) composeReaderController.toggleChapters()
						}
						com.mangaverse.app.reader.ui.compose.design.ReaderControlDestination.DISPLAY -> openMenu()
						com.mangaverse.app.reader.ui.compose.design.ReaderControlDestination.TOOLS -> composeReaderController.showTools()
						com.mangaverse.app.reader.ui.compose.design.ReaderControlDestination.TRANSLATION -> onTranslateClick()
						com.mangaverse.app.reader.ui.compose.design.ReaderControlDestination.CHAPTERS_PANEL -> {
							composeReaderController.toggleChapters()
						}
					}
				},
				onPrimaryDestinationLongPress = { destination ->
					if (destination == com.mangaverse.app.reader.ui.compose.design.ReaderControlDestination.TRANSLATION) {
