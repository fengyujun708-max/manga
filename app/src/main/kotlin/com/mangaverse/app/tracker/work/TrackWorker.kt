package com.mangaverse.app.tracker.work
...
import com.mangaverse.app.core.prefs.TrackerDownloadStrategy
import com.mangaverse.app.core.prefs.TriStateOption
import com.mangaverse.app.core.util.ext.awaitUniqueWorkInfoByName
import com.mangaverse.app.core.util.ext.checkNotificationPermission
import com.mangaverse.app.core.util.ext.onEachIndexed
import com.mangaverse.app.core.util.ext.printStackTraceDebug
import com.mangaverse.app.core.util.ext.trySetForeground
...
import com.mangaverse.app.parsers.util.toIntUp
import com.mangaverse.app.settings.work.PeriodicWorkScheduler
import com.mangaverse.app.tracker.domain.CheckNewChaptersUseCase
import com.mangaverse.app.tracker.domain.GetTracksUseCase
import com.mangaverse.app.tracker.domain.model.ContentTracking
import com.mangaverse.app.tracker.domain.model.MangaUpdates
import com.mangaverse.app.tracker.work.TrackerNotificationHelper.NotificationInfo
...
class TrackWorker @AssistedInject constructor(
	...
	private data class AutoDownloadSeed(
		val executionManga: com.mangaverse.app.parsers.model.Content,
		val displayManga: com.mangaverse.app.parsers.model.Content?,
	)
