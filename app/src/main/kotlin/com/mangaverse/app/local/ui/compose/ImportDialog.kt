package com.mangaverse.app.local.ui.compose
...
import com.mangaverse.app.local.data.importer.ImportMode
import com.mangaverse.app.local.data.importer.LocalImportKind
import com.mangaverse.app.local.ui.ImportService
...
private fun ImportTypeSelector(
    ...
    Column(modifier = modifier.selectableGroup()) {
        ...
        Row(
            ...
            ImportContentType.entries.forEach { type ->
                ImportTypeChip(
                    type = type,
