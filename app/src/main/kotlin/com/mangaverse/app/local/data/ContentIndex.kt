...
import com.mangaverse.app.core.model.ContentSource as createContentSource
import com.mangaverse.app.core.model.isLocal
import com.mangaverse.app.core.model.looksLikeVideoUrl
...
import com.mangaverse.app.parsers.util.json.getBooleanOrDefault
import com.mangaverse.app.parsers.util.json.getEnumValueOrNull
import com.mangaverse.app.parsers.util.json.getFloatOrDefault
import com.mangaverse.app.parsers.util.json.getIntOrDefault
import com.mangaverse.app.parsers.util.json.getLongOrDefault
import com.mangaverse.app.parsers.util.json.getStringOrNull
import com.mangaverse.app.parsers.util.json.mapJSONToSet
import com.mangaverse.app.parsers.util.json.toStringSet
...
class ContentIndex(source: String?) {
	...
	fun removeChapter(id: Long): Boolean {
		...
		val isPurelyLocal = mangaSource == LocalMangaSource.name
	...
	fun sortChaptersByName() {
		...
		val comparator = com.mangaverse.app.core.util.AlphanumComparator()
