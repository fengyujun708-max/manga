...
import com.mangaverse.app.core.util.ext.takeIfWriteable
import com.mangaverse.app.core.util.ext.withChildren
...
import com.mangaverse.app.local.data.output.LocalContentUtil
...
class LocalMangaRepository @Inject constructor(
	...
	suspend fun deleteChapters(manga: Content, ids: Set<Long>) = lock.withLock(manga) {
		val subject = if (manga.isLocal) {
			com.mangaverse.app.local.domain.model.LocalContent(manga)
		} else {
