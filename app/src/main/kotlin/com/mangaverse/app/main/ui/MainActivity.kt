...
import com.mangaverse.app.details.service.ContentPrefetchService
...
import com.mangaverse.app.local.ui.LocalIndexUpdateService
import com.mangaverse.app.local.ui.LocalStorageCleanupWorker
import com.mangaverse.app.main.ui.compose.ComposeAppNavBarDelegator
import com.mangaverse.app.main.ui.compose.KototoroApp
...
import com.mangaverse.app.search.ui.suggestion.SearchSuggestionViewModel
...
class MainActivity : BaseComposeActivity() {
    ...
    @Inject
    lateinit var rewardVideoManager: com.mangaverse.app.commercial.data.RewardVideoManager

    @Inject
    lateinit var session: com.mangaverse.app.core.api.MangaVerseSession
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        syncSpaceRuntime()
        // 开屏广告（启动时展示）
        val splashContainer = findViewById<android.view.ViewGroup>(android.R.id.content)
        runCatching { rewardVideoManager.showSplash(this, splashContainer) {} }
            .onFailure { android.util.Log.w("Splash", "开屏广告失败: $it") }
        ...
        setComposeContent {
            ...
            KototoroApp(
                ...
                onOpenListOptions = {
                    this.router.showListConfigSheet(com.mangaverse.app.list.ui.config.ListConfigSection.General)
                },
                onSettingsClick = {
        ...
        // 退出登录后强制重新向导（必须登录才能进入）
        lifecycleScope.launch {
            session.state.collect { s ->
                if (!s.isLoggedIn) {
                    this@MainActivity.router.showWelcomeSheet()
                }
            }
        }
