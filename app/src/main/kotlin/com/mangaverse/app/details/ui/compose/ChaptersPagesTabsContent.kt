...
import com.mangaverse.app.details.ui.pager.bookmarks.compose.BookmarksScreenRoot
import com.mangaverse.app.details.ui.pager.chapters.compose.ChaptersScreen
import com.mangaverse.app.details.ui.pager.chapters.compose.ChaptersScreenRoot
import com.mangaverse.app.details.ui.pager.pages.PagesViewModel
import com.mangaverse.app.details.ui.pager.pages.compose.PagesScreenRoot
...
private fun MetadataChapterPanel(
	...
	val context = LocalContext.current
	val viewModel = remember { mutableStateOf<com.mangaverse.app.parsers.model.ContentChapter?>(null) }
...
private fun MetadataChapterDialog(
	chapter: com.mangaverse.app.parsers.model.ContentChapter,
